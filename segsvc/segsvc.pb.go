...
type ScoreData struct {
	...
	CMR         string           `protobuf:"bytes,4,opt,name=CMR,proto3" json:"CMR,omitempty"`
}
...
func (this *ScoreData) GoString() string {
	...
	s = append(s, "CMR: "+fmt.Sprintf("%#v", this.CMR)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ScoreData) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CMR) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintSegsvc(dAtA, i, uint64(len(m.CMR)))
		i += copy(dAtA[i:], m.CMR)
	}
	return i, nil
}
...
func (m *ScoreData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CMR", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CMR = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSegsvc(dAtA[iNdEx:])
...
var fileDescriptorSegsvc = []byte{
	...
	,
}
